---
run_id: fixture-complete-0001
status: complete
testee: "/sp:dev-example 0001 --auto"
...
live_path: .spur/run/dogfood/fixture-complete-0001.md
report_path: docs/dogfood/2026-07-17-sp-dev-example-dogfood.md
protocol: sp:dogfood-testing@1.2
---

## Dogfood Report — `/sp:dev-example 0001 --auto`

### 1. Testee

- **Command:** `/sp:dev-example 0001 --auto`
- **Classification:** `slash command`
- **Exact invocation:** `Skill(skill="sp:example", args="0001 --auto")`
- **Repro:** `/sp:dev-example 0001 --auto`
...
[Report: docs/dogfood/2026-07-17-sp-dev-example-dogfood.md]
