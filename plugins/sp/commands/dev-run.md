...
argument-hint: "<wbs> [[`--mode`](../skills/spur-dev/references/dev-operations.md#flag-mode) <full|implement>] [[`--agent`](../skills/spur-dev/references/dev-operations.md#flag-agent) <name|auto>] [[`--inline`](../skills/spur-dev/references/dev-operations.md#flag-inline)|[`--subprocess`](../skills/spur-dev/references/dev-operations.md#flag-subprocess)] [--auto] [--next] [--wrap] [--continue]"
