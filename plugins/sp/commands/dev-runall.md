...
or `ready`), `--feature <id>` (sugar for `feature:<id>`), [`--mode`](../skills/spur-dev/references/flag-glossary.md#flag-mode)
...
[`--continue`](../skills/spur-dev/references/flag-glossary.md#flag-continue) (resume from checkpoint).

**`--next` (batch-once wrap).** [`--next`](../skills/spur-dev/references/flag-glossary.md#flag-next)
...
**Three orthogonal axes** (do not confuse): [`--keep-going`](../skills/spur-dev/references/flag-glossary.md#flag-keep-going)
= batch failure policy (does a failure halt the batch or skip dependents?);
[`--continue`](../skills/spur-dev/references/flag-glossary.md#flag-continue) = resume from
checkpoint (pick up an interrupted batch); [`--next`](../skills/spur-dev/references/flag-glossary.md#flag-next)
