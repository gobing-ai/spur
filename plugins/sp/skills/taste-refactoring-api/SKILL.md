...
description: A practical API design and refactoring skill for creating, reviewing, and evolving production APIs. Use it to refactor REST/HTTP, RPC/gRPC, GraphQL, and event APIs; improve resource models, naming, schemas, errors, pagination, idempotency, compatibility, security, observability, performance, documentation, and migration safety. Optimizes for clarity, consistency, evolvability, operational resilience, and developer experience.
---
