...
updated_at: "2026-09-08T22:28:36.373Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0810 | Move process-tree deadline and cancellation containment into ts-runtime | todo |
| 0811 | Make history importer cancellation settle writes and checkpoints | todo |
| 0812 | Add reusable scheduler and queue deadlines with renewable attempt ownership | todo |
| 0813 | Adopt native execution policies across Spur scheduler and history jobs | todo |
<!-- END AUTO-GENERATED -->
