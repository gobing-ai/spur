...
updated_at: "2026-08-26T18:50:07.772Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0681 | Render the agent doctor as a routing inspection surface: capability tier, executor/agent/model/roles columns, and the full role ladder | todo |
| 0682 | Remove the authentication signal from the doctor surface and collapse the doctor.probe classifier that existed to neutralize it | todo |
| 0683 | Make model health probing opt-in and cache doctor detection with a dated cache and --force-refresh | todo |
| 0684 | Add a probeAuth option to ts-ai-runner DoctorRunner and wire Spur to stop spawning per-executor auth probes | todo |
<!-- END AUTO-GENERATED -->
