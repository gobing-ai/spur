...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0613 | Record the composition measures and the four-surface script placement rule as authority | done |
| 0614 | Ship the warn-only workflow composition advisory on spur workflow validate | done |
| 0615 | Teach expert-spur and the spur-cli workflow reference to measure and fix composition defects | done |
| 0616 | Add the spur self noun and hide the four legacy standalone nouns behind it | done |
| 0617 | Add the spur builder noun with bump-ver and drop-tags promoted from spur-dev | done |
| 0618 | Consolidate shared spur CLI option declarations behind one definition site | done |
| 0619 | Add --fix to spur task check and spur feature check for structural repairs | done |
| 0620 | Add spur workflow show to render a workflow FSM as a mermaid diagram | done |
| 0621 | Remove the unreliable AUTH column from spur agent doctor table output | done |
<!-- END AUTO-GENERATED -->
