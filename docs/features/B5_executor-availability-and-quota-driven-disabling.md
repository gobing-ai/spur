...
updated_at: "2026-09-07T16:25:53.494Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0796 | Respect executor disabled state in routing and doctor | todo |
| 0797 | Safely update one existing project executor disabled flag | todo |
| 0798 | Emit precise attributed quota events from the shared agent runner | todo |
| 0799 | Apply durable quota updates and refresh running executor selection | todo |
<!-- END AUTO-GENERATED -->
