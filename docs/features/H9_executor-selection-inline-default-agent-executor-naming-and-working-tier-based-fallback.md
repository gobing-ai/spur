...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0405 | Settle agent-versus-executor naming and add the resource-exhaustion trigger | done |
| 0406 | Add inline execution mode and make it the default | done |
| 0407 | Make tier fallback fire automatically on objective failure | done |
<!-- END AUTO-GENERATED -->
