...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0385 | FeatureActionResponse contract and FeatureService.fulfillAction | done |
| 0386 | Server feature-action job consumer and action handler cutover | done |
| 0387 | Features SSE queue.job admission and runId correlation hook | done |
| 0388 | FloatingActionProgress layer, re-open chip, and api-error toast | done |
<!-- END AUTO-GENERATED -->
