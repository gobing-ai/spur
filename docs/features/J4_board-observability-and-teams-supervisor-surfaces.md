...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0374 | Add explicit module ordering to the board registry and promote Observability to first module | done |
| 0375 | Rebuild the System Events tabview on server-side queries and surface the enriched envelope fields | done |
| 0376 | Redesign the Jobs tabview as a purpose-built queue and scheduler view over a filtered query | done |
| 0377 | Add the Tasks tabview backed by the run store for pipeline digest, phase progress, and action log | done |
| 0378 | Add the Supervisor tabview as the Teams module's first and default-active tab | done |
<!-- END AUTO-GENERATED -->
