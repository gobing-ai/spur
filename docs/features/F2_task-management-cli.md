...
| WBS | Task | Status |
|-----|------|--------|
| 0050 | W1: TaskService and spur task core verbs (create/show/update/list) | backlog |
| 0051 | W1: spur task check — four-layer validation and section-matrix config | backlog |
| 0052 | W1: spur task refresh, batch-create and resolve | backlog |
| 0054 | W1: Task templates, config keys and init assets | backlog |
<!-- END AUTO-GENERATED -->
