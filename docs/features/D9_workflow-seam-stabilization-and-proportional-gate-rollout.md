...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0751 | S0a: Make workflow proof fail-closed — git-tree, task lookup, verifier freshness, artifact binding | wip |
| 0752 | S0b: Unify the workflow load/resolve/preflight seam and bind resume to the exact definition | todo |
| 0753 | S0c: Repair action options, run-id confinement, nested composition, and dry-probe escalation noise | todo |
| 0754 | S1: Repair authority and derived-doc drift, regenerate corpus/composition baselines, fix the docs-pipeline budget | todo |
| 0755 | S2: Give the inline pipeline driver a single owner and an executable parity check against task-pipeline | todo |
| 0756 | S4: Optional behavior-neutral workflow version contract in both dialects | todo |
| 0757 | Re-measure gate: re-run the workflow run-economy measurement and decide Option A continuation or the Option B stop | todo |
| 0758 | S3: Pilot the proportional route table on wrapup-pipeline and task-lifecycle with run-bound cost evidence | todo |
| 0759 | S5: Migrate task-pipeline to proportional gates, last | todo |
<!-- END AUTO-GENERATED -->
