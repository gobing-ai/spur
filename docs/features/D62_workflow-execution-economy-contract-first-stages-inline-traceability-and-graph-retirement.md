...
updated_at: "2026-09-16T11:04:28.609Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0866 | Retire workflow definitions with no real completions and no live caller | todo |
| 0867 | Expose spur workflow progress over the existing projectWorkflowProgress projection | todo |
| 0868 | Emit the structured action trace from the inline pipeline driver | todo |
| 0869 | Repair the action-boundary event contract: collapse aliases and correlate agent invocations | todo |
| 0870 | Detect and name a violated agent.run stage contract before the result is accepted | todo |
| 0871 | Route a contract violation to a repair edge, piloted on wrapup-pipeline | todo |
| 0872 | Split validation by scope: repo-wide checks move to a feature-scoped verification pass | todo |
| 0873 | Gate a candidate workflow graph change on measured real-run data with a promotion deadline | todo |
| 0874 | Refactor transition guards for legibility while preserving routing semantics | todo |
| 0875 | Stop the idea pipeline from invalidating its own preparation evidence | todo |
<!-- END AUTO-GENERATED -->
