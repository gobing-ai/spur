...
updated_at: "2026-08-24T00:47:18.343Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0643 | Features board shell layout alignment, module header, and collapsible left Feature Tree dock | testing |
| 0644 | Feature detail refactor: constrained markdown canvas, collapsible right metadata drawer, and dynamic action bar hierarchy | todo |
| 0645 | Floating agent prompt bar UI component with spirit dock icon and foldable glassmorphic container | todo |
<!-- END AUTO-GENERATED -->
