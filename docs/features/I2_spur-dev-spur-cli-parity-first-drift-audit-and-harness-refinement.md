...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0512 | Extend spur-cli/spur-dev parity harness to capture the live CLI surface | done |
| 0513 | Fix spur-cli/spur-dev drift exposed by the parity harness | done |
| 0514 | Content pass: README index, cross-links, and structured-catalog ownership | done |
| 0515 | Harden sp-dev-idea planning handoff from dogfood findings | done |
| 0516 | Parity scope data: explicit exclusions and the ADR-054 ownership boundary | done |
