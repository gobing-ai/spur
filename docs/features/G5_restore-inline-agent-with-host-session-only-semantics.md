...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0565 | Headless --agent inline special error across CLI, service, and workflow action | done |
| 0566 | Explicit-inline zero-dispatch contract across sp commands and skills | done |
<!-- END AUTO-GENERATED -->
