...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0553 | Retain forensic primitives at import: todo-arg allowlist and per-call latency | todo |
| 0554 | Compute derived variables in analyze via an in-analyze metric registry | todo |
| 0555 | Add the report mode registry and the forensics renderer | todo |
| 0556 | Rewrite dev-find-issue as report-first over the data plane | todo |
<!-- END AUTO-GENERATED -->
