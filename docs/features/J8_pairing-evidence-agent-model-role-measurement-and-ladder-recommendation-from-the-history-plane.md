...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0573 | Pairing aggregation in the analyze artifact: per-(agent,model,role) stats | done |
| 0574 | Pairings report mode: ranked table + ladder-diff recommendations | done |
<!-- END AUTO-GENERATED -->
