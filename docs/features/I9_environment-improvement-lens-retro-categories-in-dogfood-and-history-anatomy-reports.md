...
I'll load the AC style guide and feature I9, then write R-numbered Gherkin scenarios from the feature file.I have the feature path and style-guide location; next I’ll read those plus the feature CLI AC contract.The feature file is a stub; I’ll pull dogfood, history-anatomy, and retro mapping details so the scenarios match real scope.The brainstorm plan is the decision source; I’ll read it plus nearby I8/I81 AC and the report contracts.```gherkin
