...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0056 | W2: FeatureService and spur feature core verbs with hierarchical IDs | done |
| 0057 | W2: spur feature check — AC validation, one-active-goal and children limit | done |
| 0058 | W2: spur feature refresh — INDEX tree and Tasks auto-population | done |
| 0060 | W2: Task-to-feature traceability validation (L4) | done |
| 0061 | W2: spur feature move — cascade rename for hierarchy changes | done |
| 0340 | spur feature check --strict reports PASS when a linked AC scenario is known-unsatisfied | done |
<!-- END AUTO-GENERATED -->
