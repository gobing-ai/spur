...
| WBS | Task | Status |
|-----|------|--------|
| 0046 | W0: Task and feature lifecycle workflow YAML definitions | backlog |
| 0049 | W1: PlanningWriteService — unified write path with atomic writes | backlog |
| 0053 | W1: Planning events — PlanningEventMap, DAOs and DB migration | backlog |
| 0055 | W1: Task lifecycle engine integration with file-wins rehydration | backlog |
| 0059 | W2: Feature lifecycle engine integration including verifying | backlog |
<!-- END AUTO-GENERATED -->
