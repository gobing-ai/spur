...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0594 | dev-* spine cost + drift inventory: measure the bootstrap, attribute it, name the fix path | todo |
| 0595 | Harness eval suite: fixture task set + pipeline parity comparator | todo |
| 0596 | task-pipeline2.yaml: two-layer plan from workflow --dry-run --json + residual-sweep stage | todo |
| 0597 | Event 5W1H audit + the event-tracking SSOT design doc | todo |
| 0598 | Run-record consolidation + the History/Observability read plane | todo |
| 0599 | Workspace / Inbox / Teams responsibility boundary under the agent-role mechanism | todo |
<!-- END AUTO-GENERATED -->
