...
updated_at: "2026-09-03T16:31:48.492Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0738 | History schema trust gate: dependency drift, source-table assertion, and version-mismatch abort | todo |
| 0739 | Persist tool identity at import: effective_tool_name, tool_name_alias, and the alias resolution seam | todo |
| 0740 | Complete the measure vector on existing rollup tables and enforce the additivity invariant | todo |
| 0741 | Incremental rollup refresh engine: watermark, per-table freshness, transactional bucket rebuild, and definition versioning | todo |
| 0742 | Assert incremental rollups equal a full rebuild | todo |
| 0743 | Dimension marts and Summary read routing with bounded staleness fallback | todo |
| 0744 | Sort and paginate session listing in SQL on both read paths | todo |
| 0745 | Verify the History surface is unchanged and record the latency result | todo |
| 0746 | Import ledger retention to reduce database size without affecting board reads | todo |
<!-- END AUTO-GENERATED -->
