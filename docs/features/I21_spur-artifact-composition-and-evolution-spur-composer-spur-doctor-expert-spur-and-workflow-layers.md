...
updated_at: "2026-09-11T18:39:01.373Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0819 | Workflow list and name resolution share the project, registered and shared layers | testing |
...
| 0822 | Workflow validate reports composition findings by level and fails on the caps | todo |
| 0823 | task-pipeline stays within the composition budgets | todo |
| 0824 | idea and wrap-up pipelines stay within the composition budgets | todo |
| 0825 | feature-dev, pr-review, wayfinder, docs and basic stay within the composition budgets | todo |
| 0826 | spur-check enforces shared-workflow composition caps and pipeline-budget coverage | todo |
| 0827 | Step profiles give spur-doctor per-node duration, idle-gap and cache evidence | todo |
<!-- END AUTO-GENERATED -->
