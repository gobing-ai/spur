...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0431 | spur workflow run validates against node-resolved schemas instead of the embedded map | todo |
| 0432 | Workflow var interpolation into shell action commands executes as shell | done |
| 0433 | Headless HITL taste gates cannot be approved after the fact | todo |
