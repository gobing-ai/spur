...
updated_at: "2026-09-03T16:10:25.445Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0747 | Repatriate importer-owned columns to the importer schema without rewriting applied migrations | todo |
| 0748 | Importer schema version: exported constant, ledger record, and mismatch check | todo |
| 0749 | Source-to-table registry replacing hardcoded table lists, with an ownership conformance test | todo |
<!-- END AUTO-GENERATED -->
