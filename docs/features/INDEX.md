...
[active] **B**: Agent execution ([B_agent-execution.md](./B_agent-execution.md))
    ...
    └── [active] **B3**: Role routing SSOT in spur config: code-owned defaults, config override, roles.md as projection ([B3_role-routing-ssot-in-spur-config-code-owned-defaults-config-override-roles-md-as-projection.md](./B3_role-routing-ssot-in-spur-config-code-owned-defaults-config-override-roles-md-as-projection.md))
...
[done] **E**: History ([E_history.md](./E_history.md))
    ...
    ├── [active] **E5**: Session forensics implementation: retention, derived variables, report modes, find-issue rewrite ([E5_session-forensics-implementation-retention-derived-variables-report-modes-find-issue-rewrite.md](./E5_session-forensics-implementation-retention-derived-variables-report-modes-find-issue-rewrite.md))
...
[active] **I**: sp plugin ([I_sp-plugin.md](./I_sp-plugin.md))
    ...
    ├── [backlog] **I4**: Subagent role propagation across parallel fan-out ([I4_subagent-role-propagation-across-parallel-fan-out.md](./I4_subagent-role-propagation-across-parallel-fan-out.md))
    └── [active] **I5**: dev-history-load command: on-demand cumulative import + analyze ([I5_dev-history-load-command-on-demand-cumulative-import-analyze.md](./I5_dev-history-load-command-on-demand-cumulative-import-analyze.md))
