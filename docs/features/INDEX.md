...
[done] **I**: sp plugin hands-off ready ([I_sp-plugin-hands-off-ready.md](./I_sp-plugin-hands-off-ready.md))
    └── [verifying] **I1**: dev-idea: drop --design force path + idea-evaluation taste gate ([I1_dev-idea-drop-design-force-path-idea-evaluation-taste-gate.md](./I1_dev-idea-drop-design-force-path-idea-evaluation-taste-gate.md))
