...
[active] **G**: Collaboration ([G_collaboration.md](./G_collaboration.md))
    ...
    └── [backlog] **G5**: Restore inline --agent with host-session-only semantics ([G5_restore-inline-agent-with-host-session-only-semantics.md](./G5_restore-inline-agent-with-host-session-only-semantics.md))
