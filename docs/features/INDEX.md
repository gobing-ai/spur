...
[active] **H**: Agent integration ([H_agent-integration.md](./H_agent-integration.md))
    ...
    ├── [done] **H8**: sp command surface coherence: --next as run-to-completion, flag vocabulary normalization, semantic parity gate ([H8_sp-command-surface-coherence-next-as-run-to-completion-flag-vocabulary-normalization-semantic-parity-gate.md](./H8_sp-command-surface-coherence-next-as-run-to-completion-flag-vocabulary-normalization-semantic-parity-gate.md))
        ├── [backlog] **H81**: Dev command argument contract clarity ([H81_dev-command-argument-contract-clarity.md](./H81_dev-command-argument-contract-clarity.md))
        ├── [backlog] **H82**: Unified --agent execution-surface selector ([H82_unified-agent-execution-surface-selector.md](./H82_unified-agent-execution-surface-selector.md))
        └── [backlog] **H83**: Run-scoped agent session affinity, live agent streaming, unified --agent inline ([H83_run-scoped-agent-session-affinity-live-agent-streaming-unified-agent-inline.md](./H83_run-scoped-agent-session-affinity-live-agent-streaming-unified-agent-inline.md))
