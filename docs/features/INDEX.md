...
[done] **E**: History ([E_history.md](./E_history.md))
    ...
    ├── [active] **E3**: Operation-triggered history refresh: coalesced import and analyze off the hot path ([E3_operation-triggered-history-refresh-coalesced-import-and-analyze-off-the-hot-path.md](./E3_operation-triggered-history-refresh-coalesced-import-and-analyze-off-the-hot-path.md))
...
[active] **I**: sp plugin ([I_sp-plugin.md](./I_sp-plugin.md))
    ...
    ├── [backlog] **I3**: Harness surface reconciliation: plugins/sp and workflow YAML against the live spur CLI ([I3_harness-surface-reconciliation-plugins-sp-and-workflow-yaml-against-the-live-spur-cli.md](./I3_harness-surface-reconciliation-plugins-sp-and-workflow-yaml-against-the-live-spur-cli.md))
...
[active] **M**: Teams: declarative agent teams + Board module over existing message/drain/supervisor backbones ([M_teams-declarative-agent-teams-board-module-over-existing-message-drain-supervisor-backbones.md](./M_teams-declarative-agent-teams-board-module-over-existing-message-drain-supervisor-backbones.md))
    ...
    └── [backlog] **M5**: Teams declared by role: a member is a role plus an executor ([M5_teams-declared-by-role-a-member-is-a-role-plus-an-executor.md](./M5_teams-declared-by-role-a-member-is-a-role-plus-an-executor.md))
