...
[active] **D**: Workflows ([D_workflows.md](./D_workflows.md))
    └── [verifying] **D1**: workflow run observability — enriched step lines, FSM transitions, async follow ([D1_workflow-run-observability-enriched-step-lines-fsm-transitions-async-follow.md](./D1_workflow-run-observability-enriched-step-lines-fsm-transitions-async-follow.md))
