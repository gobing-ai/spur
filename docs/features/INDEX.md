...
[active] **B**: Agent execution ([B_agent-execution.md](./B_agent-execution.md))
    ...
    └── [backlog] **B3**: Role routing SSOT in spur config: code-owned defaults, config override, roles.md as projection ([B3_role-routing-ssot-in-spur-config-code-owned-defaults-config-override-roles-md-as-projection.md](./B3_role-routing-ssot-in-spur-config-code-owned-defaults-config-override-roles-md-as-projection.md))
