...
[active] **H**: Agent integration ([H_agent-integration.md](./H_agent-integration.md))
    ...
    ├── [backlog] **H8**: sp command surface coherence: --next as run-to-completion, flag vocabulary normalization, semantic parity gate ([H8_sp-command-surface-coherence-next-as-run-to-completion-flag-vocabulary-normalization-semantic-parity-gate.md](./H8_sp-command-surface-coherence-next-as-run-to-completion-flag-vocabulary-normalization-semantic-parity-gate.md))
    └── [backlog] **H9**: Executor selection: inline default, agent/executor naming, and working tier-based fallback ([H9_executor-selection-inline-default-agent-executor-naming-and-working-tier-based-fallback.md](./H9_executor-selection-inline-default-agent-executor-naming-and-working-tier-based-fallback.md))
