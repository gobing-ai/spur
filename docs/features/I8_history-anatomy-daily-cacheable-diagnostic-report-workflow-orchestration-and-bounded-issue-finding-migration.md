...
updated_at: "2026-08-25T04:03:17.788Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0657 | HA-S1: true population counts and truthful coverage rendering in the history forensics artifact | todo |
| 0658 | sp:history-anatomy skill: mode contract, finding taxonomy, and the eleven-section report contract | todo |
| 0659 | History-anatomy cache helper: semantic artifact digest, invalidation matrix, structure gate, atomic publish | todo |
| 0660 | history-anatomy.yaml workflow: cache branch, deterministic stage ordering, bounded correction, atomic publication | todo |
| 0661 | Repoint /sp:dev-find-issue, remove /sp:dev-history-load, and land the coexistence and surface documentation | todo |
<!-- END AUTO-GENERATED -->
