...
updated_at: "2026-09-15T05:09:18.474Z"
---
...
| WBS | Task | Status |
| --- | ---- | ------ |
| 4856 | Delete spur projects migrate and LegacyMigrationService | todo |
| 4857 | Retire the agent.team roster runtime | todo |
| 4858 | Declare the project fleet under agent.fleet and gate serve on enabled | todo |
| 4859 | Reconcile agent.fleet.strategy into project_strategy at serve start | todo |
| 4860 | Rename the remaining team runtime vocabulary and split TeamService | todo |
| 4861 | Sync authority documents with the agent.fleet surface | todo |
<!-- END AUTO-GENERATED -->
