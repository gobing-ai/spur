...
| WBS | Task | Status |
| --- | ---- | ------ |
| 0222 | Liveness status strip for System Events header | todo |
| 0223 | System Events table view with color-coded event names | todo |
| 0224 | Redesigned System Events filter bar | todo |
| 0225 | Responsive layout and WCAG compliance for System Events table | todo |
<!-- END AUTO-GENERATED -->
