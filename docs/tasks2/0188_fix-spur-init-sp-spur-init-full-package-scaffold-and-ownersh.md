...
| ---------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `templates/task/brainstorm.md`                                                                                                           | NO — the source file already exists in `config/templates/task/brainstorm.md`; `TASK_VARIANTS` (packages/domain/src/planning/schema.ts:105) has 6 variants but `SCAFFOLD_MANIFEST` ships only 5 task-template entries. Confirmed functionally: `spur task create ... --template brainstorm` in a fresh dir silently falls back to a bare frontmatter stub (no error, no real template body) because `.spur/templates/task/brainstorm.md` doesn't exist.                                                                                                                                                                                                                                                                                                | Add one `SCAFFOLD_MANIFEST` entry: `{ source: 'templates/task/brainstorm.md', target: 'tasks/templates/brainstorm.md' }`. No new bundled content needed — the source already exists.                                                                                                                                                                                                                                                                                    |
