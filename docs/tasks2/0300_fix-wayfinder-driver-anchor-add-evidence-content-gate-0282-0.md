...
updated_at: "2026-08-18T04:42:47.632Z"
---
...
|----|--------|---------------|----------|
| Scenario: Solution anchor matches real section line | MET | static-ref | `config/workflows/wayfinder-resolution.yaml:70-72` — agent instructed to grep-resolve the real section line and cite it |
