...
- [x] D61: essential workflow gates, explicit corpus audits, snapshot retirement, and versioned
  ...
  Post-delivery workflow defects remain tracked separately by the 0781 audit and its follow-ups;
  this delivery marker does not activate proportional fast routing.
