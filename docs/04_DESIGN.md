...
- Pipeline integration (task 0328; bounded by 0411, amended by 0625): `task-pipeline.yaml`'s
  ...
  trusted workflow var `featureGateCmd` (default `bun run spur-check` — the full repo gate; 0775
  retired the corpus sweep this hop previously ran) when `applied` is true or
