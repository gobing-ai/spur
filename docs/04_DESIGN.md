...
| [`observability-module-refactor.md`](design/observability-module-refactor.md)                           | Observability Board Summary/Jobs refactor — summary aggregations, 4h default, `queue_jobs` table, schedule tracing; top event types carry `avgDurationMs` + `failureCount` (J93 / 0789–0793)                                                              | built (0789–0793)                                                                                                                                               |                                                                                                                               |             |
...
[`observability-module-refactor.md`](design/observability-module-refactor.md) §3.1.
