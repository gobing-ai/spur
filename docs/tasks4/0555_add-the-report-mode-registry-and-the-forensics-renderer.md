...
- **Specification:** feature E2 § _Decisions so far_ — "Report modes are built-in named renderers, not
  ...
  artifact)
- **Pricing amendment (R3):** feature J6 § _Tokens, not prices_ (operator ruling 2026-08-13);
...
- **Source material:** `.spur/run/sp-dev-find-issue-20260806.md` (the 423-line output to reproduce);
