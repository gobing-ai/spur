...
| `apps/web/src/modules/features/FeaturesShell.tsx:8,336` | Import + mount `<FloatingAgentBar />` in the returned fragment after `NewFeaturePanel` — no other shell change. |
