...
> (1) ADR-072 is **Accepted** (`docs/00_ADR.md:883`) and `config/workflows/planning-pipeline.yaml` is
> deleted. (2) The D5-N promotion bar is **retired** by ADR-076 (`docs/00_ADR.md:966`) and
