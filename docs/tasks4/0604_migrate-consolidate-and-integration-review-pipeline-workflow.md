...
| Scenario: R3 — Task execution preserves verification proof and ends with one canonical pipeline | PARTIAL | static-ref | `config/workflows/task-pipeline2.yaml:505` residual-sweep snapshot-bracketed; D5-N promotion bar blocked by HTTP 429 (omp quota ~3.96 days), operator recorded-and-deferred |
