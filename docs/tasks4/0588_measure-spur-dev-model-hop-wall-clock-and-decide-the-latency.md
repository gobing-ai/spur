...
| R3 | MET | `### Design` option matrix at `docs/tasks4/0588_measure-spur-dev-model-hop-wall-clock-and-decide-the-latency.md:118-123` — 3 option rows, each carrying cost, risk and confirming measurement; exactly one recommendation at `:125`. Mechanism change routed to ADR-064, `docs/00_ADR.md:754`, re-read this run |
