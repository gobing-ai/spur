...
| R5. Document the registry as the place new shared options are added, in `docs/04_DESIGN.md` and the `sp:spur-cli` reference. | MET | `SHARED_OPTIONS` documented: `docs/04_DESIGN.md` §1.0.1 "Shared option registry" (`docs/04_DESIGN.md:121-127`) + `plugins/sp/skills/spur-cli/SKILL.md:106-112` + note appended to all 8 noun reference files. |
