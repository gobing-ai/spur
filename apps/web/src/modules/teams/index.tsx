 ...
 * sibling directories exporting a `WebModule`). v1 ships the Roster, Terminal,
 * Messages, and Activity tabs. Terminal embeds MemberTerminal (0255); roster
 * consumes the team API (0256).
 */
