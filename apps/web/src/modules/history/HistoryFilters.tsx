...
export const HistoryFilters: React.FC<HistoryFiltersProps> = memo(
    ({ filter, onChange, sourceOptions = [], modelOptions = [], toolOptions = [], skillOptions = [], scope }) => {
