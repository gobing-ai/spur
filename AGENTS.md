...
spur rule       run [--preset <name>] [--file <path>] [--rule <id>] [--fail-on <severity>] [--stop-on-first [<severity>]] [--fix-mode <none|suggest|auto>] [--dry-run] [--verbose] [--json]
...
spur task       update <wbs> [status] [--section <name> --from-file <path>] [--feature <id>] [--priority <p>] [--no-lifecycle] [--json]
