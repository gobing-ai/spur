...
- add plans module with roadmap and plan file browser (318fc806b)
- pause headless implement steps on an operator question (0933) (dab30de06)
- add --answer-text to spur workflow continue for input gates (0932) (f060a84d6)
- isolate parallel batch tasks in per-task worktrees (0931) (076631192)
- runall batch wrap covers only done tasks, reports the rest (F96 0952) (4ddda7fe5)
- standalone verify residual fold, router C6 STOP, owning docs (F96 0951) (3da3d3c03)
- wire residual sweep into task-pipeline verify/done/failed (F96 0950) (c7d9e35ed)
- add residual-scan script with scan/fold/settle/report modes (F96 0949) (d0e448d9a)
- run target onEnter shells during feature-lifecycle hops (775e4e908)
- scaffold residual-sweep feature, design and task batch (648bacf58)
- bound workflow trace --follow with --timeout; pin batch verdict acceptance (0930) (f2866492a)
- persist workflow runs as two-file records with bounded Board inspection (755211d9f)
- warn on dropped feature scenario keys at task record time (fe4fe3a88)
- add designs module with file browser and toc (bceee83d4)
- bind --continue to the original frozen batch identity (0919) (b80a1703c)
- lock interrupted-entry replay posture (0916) (4f9e65de2)
- make history-anatomy scope validation deterministic (8edb8aa4d)
- bind feature completion to feature-verification receipts (dd1933c56)
- direct workflow diagram view and streamlined yaml drawer (4a8ca580b)
- add workflows endpoint and test coverage (c46b864b7)
- refreshProjects process cleanup, CLI clean verb, and worktree teardown deregistration (feature K3) (9f065e4b7)
- improve workflows diagram layout with markdown viewer and orientation toggle (92e838716)
- add dynamic theme detection and responsive scaling to mermaid markdown viewer (518607850)
- enhance workflow mermaid styling with explicit default class and fenced markdown snippets (ddc47a226)
- add workflows tab in settings with yaml and diagram viewers (84e420a6e)
- expose project workflows endpoint with raw yaml and mermaid diagrams (803c51d09)
- add general settings tab with yaml syntax highlighting for configs (56cc4aaa2)
- expose project and global config files endpoint (53816a7c8)
- add settings module and navigate from left sidebar (1a74f607a)
- enhance agents view with pipeline stages and multi-line executor tooltips (ef5fc78ec)
- trustworthy reports and honest session-review observations (df8b92e77)
- show all candidate executors in current tier on agent role cards (f67be49e0)
- establish post-delivery workflow baseline and select pilot (0912) (ba75c1e4f)
- add executor ready/disabled toggle with source-layer tags (f6f7bc721)
- add executor availability toggle and config-layer provenance (5efc7e3cd)

### Fixed

- merge F96 residual report with 0933 escalation note in failed onEnter (bbf25cf11)
- pass featureId + spurBin to nested verifying run (0948 R1) (41eca57b9)
- flag hardcoded record filenames (0948 R8) (32e7b08e3)
- project `ok` and use exclusive create (0948 R7) (c2326687e)
- reject unknown flags and first positional wins (0948 R4) (1ff024b1d)
- explicit module mode; source mode names the fix (0948 R3) (e8683603d)
- typed invalid-run-id + caller --vars merge + safe read + state redaction (0948 R2/R5/R6) (c5a667f84)
- close out E7 review findings and repair the feature-verification caller (0948) (d261f880c)
- lint premises evidence and feature binding at handoff-finalize (0947) (9553d7af4)
- lock timeout integer rejection and close H53 (0930) (9481fcf6e)
- support engine 0.5.5 template-bound shell env in workflow runners (05b9f4936)
- await async openInlineRunProjectDb in feature-verification-steps (6b28a4574)
- pin promotion gate to registration baseline and resolve 0921 candidate (f022203f6)
- address 0920 review findings (stale comment, biome warnings, twin regen) (71c04f31f)
- make receipt rejection codes unsuppressible at the done boundary (03ad5e3b0)
- make plugin-lib bundles byte-deterministic (013ae0711)
- conform feature verification completion to v1 receipt contract (ac3cc23b7)
- apply all task update field flags and write estimate_hours as a number (9063f6ee0)
- uncorrupt edge labels, format transitions, and refine diagram UI (b1cea2e5f)
- handle specless project listing and add server request timeouts (f59452cc5)
- sync projects clean help doc, json inventory, and deleted project test (ada0bad43)
- make installed inline execution portable (0914) (676a405b4)
- avoid forbidden config/workflows path literal in runtime code and tests (79a79abbe)
- replace direct node:fs with runtime fs in workflows handler (257c82d58)
- reject fabricated per-row cache share and missing footer tokens (026e5ba3b)
- add missing tsdoc on executor availability fleet types (474f8db09)

### Changed

- record F96 verifyall sweep and residual check evidence (4179617ac)
- update memory (4e24c4141)
- record wrapup learnings and metrics for batch 0931-0934 (e8a39901d)
- record ADR-127 and sync 03/04 satellites with batch 0931-0933 (720bcf303)
- re-verify legacy umbrella scenarios and close out batch 0934 (1040bd633)
- wrapup doc-sync + learnings for F96 batch (0949-0952) (9dac6d668)
- key F96 task Testing evidence to feature scenarios (durable, tracked) (16d5f80e4)
- merge 'sp/runall-f96-69be' into main (c82c22f0d)
- features INDEX row for F96 done (6ea1be91e)
- F96 dogfood report + feature done (F96 0952 wrap) (ee7d885a8)
- updat tasks after verification (c77a67f52)
- sync main into sp/run-0948-2171 before fast-forward (417d1ad8f)
- sync 0887 status to done and flip D63 active (e3c2755e5)
- updat tasks after verification (c8949abe3)
- updat tasks after verification (feaf0bbaf)
- mark 0928 path corrections + 0948 R1-R9 / AC1-AC6 close-out (164b868d0)
- update dev command coverage for 0948 close-out (40d11d796)
- worktree outside .spur/ + copy-out mandatory + verify-answer contract (0948 R9) (48a42e8b1)
- link task-residual-sweep design and register F96 (fe72c1916)
- record 0947 pipeline results (Testing/Review, status done) (2b8e5601a)
- 0931 implement dispatched (0003871f5)
- H1 batch checkpoint — runall-h1-0c62 active (1c994bdfe)
- session log — H1 gate evidence repair (fa29d96aa)
- update memory (70fe0a953)
- record 0930 done in H53 task table and index (3d413680f)
- file 0948 for the E7 review findings and record the batch pitfalls (239077c2b)
- re-verify all E7 tasks with fresh evidence and repaired anchors (245f6d586)
- document E7 batch lessons and feature-done pitfalls (a1041e3e7)
- sync generated plugin bundles with engine 0.5.5 (565083e8f)
- use catalog: for @gobing-ai/ts-* in root package.json (4864aab77)
- feature E7 verifying -> done after the feature-scoped verification pass (c424af9f5)
- record the E7 dogfood pass and feature-sync status refresh (434c9cb19)
- update the project dependency (8419fb026)
- close 0936 and refresh 0935 round-4 evidence (c407c5ecf)
- document scenario-key carry-forward in code-verification (6328e297d)
- plan the measured workflow-catalogue refactor (4b734ddac)
- settle D63 evidence debt and record the 0935 wrap-up (9b0e15637)
- 0935 wrap-up — record, review round 2, verify PASS, learnings, metrics (1651b1413)
- pin promotion gate phrasing and settle 0917 inline-run evidence debt (D63) (f10628a0a)
- document subshell-cd requirement for targeted workspace tests (4c84ec3c5)
- file task 0935 — carry all D63 open items (0917 evidence debt, push sync, cleanup, review residues) (08be6cf2b)
- merge 'sp/0921': D63 R8 measured migration completion + promotion-gate baseline fix into main (5227e2f39)
- restore large-screen floating panels in designs module (25bbf5ef2)
- restore large-screen floating panels in features module (ec5be7f90)
- adapt features module layout for laptop screen widths (78a4110b9)
- reconcile D63 task statuses after round-2 merge (555598cff)
- record 0917 insufficient-evidence audit and close task (978d4a263)
- record 0919 verify PASS and close task (0841d2dcf)
- pin blocked outcomes for changed deps and lost worktree (0919) (6ecd8b181)
- record 0916 verify PASS and close task (bea15b263)
- merge 'sp/runall-d63-767a' into main (a53751c98)
- sync feature D63 after batch completion (4babbcb96)
- record 0920 verdict evidence and close checklists (ff83ef7a5)
- record 0918 review/verify evidence (a43967261)
- correct 0918 cohort per-bucket digest attribution (458afa98a)
- record 0918 idea-cohort INSUFFICIENT_EVIDENCE disposition (9e874de17)
- record 0915 verdict evidence and close checklists (6c7c4f908)
- scope wrapup feature-verify hop to the feature gate command (94e655755)
- simplify general and agents views under settings module (9abd6f135)
- refresh H1 scope for batch execution v2 slices (267f848f9)
- re-baseline batch execution v2 as tasks 0931–0934 (4d4077a62)
- add H53 task 0930 for bounded watchers and stale-result rejection (da1bfab98)
- record review findings (changes-requested, 2 majors) (70079550d)
- re-parent P under H5 as H53 and update references (5f5821a3c)
- add E7 run-record and inspection task batch (494fd24de)
- rebaseline E7 scope to the workflow run record (89c033b28)
- rebaseline run-record contract and Tool Using ownership after J92 (a27d4c6e5)
- key 0914 verdict evidence to D63 scenario R1 (a1deeaaea)
- updat tasks after refinment (b041f4a80)
- record task 0912 wrapup learnings and metrics (9ae762960)
- mark D62 done after task 0912 baseline delivery (74807ba77)
- add workflows reading surface satellite with 04 index row and surface section (57c1ecb67)
- record D63 ready handoffs and evidence gate (8a45f8add)
- prepare 0920 deterministic scope change (a4e37254f)
- prepare 0918 measured idea candidate (ba85d196a)
- prepare 0915 receipt implementation handoff (f7e31d068)
- align D63 workflow rollout with pilot evidence (7c2f337ee)
- guard tilde-heal test against sandboxed $HOME writes (87a54d21e)
- plan feature K3 and tasks 0922-0924 for registry freshness (4812a8014)
- pin environment-lens anchor parity with its design satellite (fdf8d14dc)
- record re-verified evidence for task 0913 (a5c75bdd2)
- remove agents tab from projects module (7885af8c8)
- wrap 0912 — learnings and wrapup metrics (fb59ee798)
- refresh 0912 Testing section from standalone re-verify (bfce2ab0c)
- merge 'sp/run-0912-6441': task 0912 workflow baseline + contracts tsdoc gate repair into main (69b111c15)
- register D63 workflow adoption plan and tasks (9fed388b6)
- add tasks 0912 and 0913 and sync feature indexes (dc109b0e4)
- update the project dependency (4f472417c)
...
- web: reinstate supervisor uptime on the agents roster card (af37c8098)
- web: restore the retired process watch list as the Work Processes section (d90bfbab7)
- builder: version-carrier type registry for pluggable release carriers (7459d418e)
- builder: version carriers as project config for all project shapes (6b1997fdf)
- config: declare builder.bump-ver release knobs in project + example configs (80b55bc01)
- builder: config-driven release knobs + marketplace fidelity + runtime-db noise tolerance (81d65ac19)
- web: surface member workDir and model on MemberDetail pane (2e04ff499)
- web: move sidebar fold to footer; switcher anchors collapsed rail (0805d3a59)
- skills: add new agent skill taste-refactoring-tests (1d6bb530a)
- skills: add new agent skill taste-refactoring-architect (bc025c73f)
- skills: add new agent skill taste-refactoring-api (41275aa19)
- skills: add new agent skill taste-refactoring-api (f85724352)
- skills: add new agent skill taste-refactoring-ui (b589099ce)
- agent: wake the orchestrator loop on events, not polling (79d2d3a56)
- app: persist REST and GTD strategy runtime across restarts (f04cc1209)
- app: lease write slots by ownerEpoch and strategy version (8e42eb6b7)
- app: bind a single active orchestrator owner per project (63f7cd7d5)
- app: declare project fleet with stable instance identity (d49e2bf7c)
- workflow: gate shared definitions and budget coverage in spur-check (0826) (e47a6665c)
- workflow: give spur-doctor step profiles for duration, idle gap and cache evidence (0827) (0281be288)
- workflow: keep the five shared workflows within composition budgets (0825) (62b708c2c)
- workflow: keep idea and wrap-up pipelines within composition budgets (0824) (791f44ece)
- workflow: keep task-pipeline within composition budgets via closed owners (0823) (0d9cd9cd9)
- workflow: report composition findings by level and gate validate exit (0822) (bef926fba)
- sp: bind spur skills into expert-spur and retire spur team guidance (0821) (0cb7f927f)
- sp: add spur-composer and spur-doctor skills for artifact composition and evolution (0820) (6b17be347)
- workflows: unify workflow list and name resolution over ordered layers (0819) (35607b15e)

### Fixed

- app: resolve fleet roles from agentConfig when ctx.roles is unset (c209f257d)
- fleet: materialize declared agents before server admission (fa390c5da)
- migration: preserve database and mailbox identities during conversion (d8a0ef89c)
- app: keep health receipt projection read-only (9778eb402)
- agent: tolerate absent wake diagnostics and record 0839 verification (d0b9bcad4)
- agent: persist and consume task message and completion wakeups (99d8fb748)
- agent: keep fleet assignments queued while strategy is rest (054a69f5c)
- fleet: order capacity allocation and gate selection on reconciliation (b8394c0ad)
- fleet: fence write claims against persisted strategy and generations (fab002aca)
- fleet: require the live claim to match the orchestrator binding (b48a9cae6)
- agent: treat only prompt invocations as delivery proof (031e68085)
- receipts: notify listeners after durable exit persistence (0833) (4b5137fe1)
- reconciliation: retain delivered and interrupted request outcomes (0834) (3364c2334)
- receipts: persist request origin before dispatch (0833) (bc070f5fa)
- messages: expose durable request keys in send receipts (0832) (a2aa3d259)
- budgets: reconcile idea-pipeline query budget to six stages (1f4d5833b)
- workflow: read current-run precheck status in docs draft guard (b9ffe4fad)
- workflow: record malformed roster failures safely (0825) (bbe70bf04)
- workflow: preserve quality gate stream capture (0823) (3273a4655)
- workflow: honor listed layer precedence in name resolution (0819) (7a9432ca4)

### Changed

- server: remove orphaned POST /api/team/:team/up|down routes (56b8dddfa)
- web: bump board layout state to v3 with v2 migration (6224e6067)

### Other

- docs(g64): record task verification evidence and retirement-surface dogfood index (9bc70762a)
- test(server): restore lazy-context singleton coverage after 0855 route-test removal (3b7b8739e)
- chore(memory): record 0852 wrapup learnings and metrics (8f8dc45da)
- docs(g64): move feature to verifying with tasks 0852-0855 done (710004ba2)
- chore(memory): record 0854 wrapup learnings and metrics (run e19046ce) (a32f345cd)
- docs: refresh stale Inbox surface reference in project-switcher design (157852e1e)
- docs(g64): record ADR-116 retirement of team-scoped Board ADRs and pin supersession guards (a1c647eae)
- chore(memory): record 0850 wrapup learnings and metrics (run 003152d0) (b93fc93e2)
- docs(README.md): update README.md (f82a839b7)
- chore(memory): record 0850 wrapup learnings and metrics (e189a1423)
- docs: refresh contract metadata and stale surface claims after the G64 reconciliation (e23efdaaa)
- docs(g64)!: record ADR-052 supersession and reconcile its derived owners (7db3fb9ba)
- chore(spur): record 0849 retirement learnings and wrap metrics (f2f0bb234)
- refactor(web)!: retire Workspace, Inbox, and Teams board routes with redirects (2ba02214f)
- chore(skills): tighten taste-refactoring descriptions (1157f7e2b)
- docs(design): document role-only roster behavior in project switcher (6a53473d3)
- docs(g64): record deferred disposition for cleanup tasks 0849/0850 (c1ca46e24)
- docs(g64): ship four-task release and reconcile M3/M6 closure (e9b1c0dae)
- chore(config): declare the binaryVersion ts-literal carrier explicitly (defaults, dogfood) (bf2621203)
- chore(plugins/sp): register taste-refactoring-* skills with frontmatter (3e0da31bb)
- chore(config): remove redundant config items for agent (6247c3b5f)
- docs(verify): record G64 task 0851 verification evidence (6d8a01a2c)
- docs(verify): record G64 task 0850 verification evidence (58380da55)
- docs(verify): record G64 task 0849 verification evidence (692364092)
- docs(verify): record G64 task 0848 verification evidence (ed078c4b0)
- docs(verify): record G64 task 0847 verification evidence (c96f1fd5b)
- docs(verify): record G64 task 0846 verification evidence (cd3b675e4)
- test(fleet): move role validation checks with their shared owner (cd52471dc)
- chore(tasks): cancel superseded G6 cleanup tasks 0849 and 0850 (4cc0f9d65)
- docs(reports): record fresh G63 production browser re-verification (4885b9e9c)
- docs(tasks): rewrite G6 Testing sections as verify-result tables (bcd004f29)
- docs(feature): record G62 verification evidence (cfbf134c2)
- docs(verify): record G62 re-audit failures and shippable blockers (2ed1c0878)
- docs(task): record 0838 remaining GTD integration failure (2a6d18a21)
- docs(task): record 0837 residual owner fencing failure (273f03490)
- docs(task): record 0836 ownership verification failure (e1ca285be)
- docs(task): record 0835 forced verification as partial (5ce533a22)
- test(fleet): seed the declared orchestrator in CLI state coverage (b2ab4e2a4)
- docs(feature): record G61 closeout PASS against released 0.4.66 (06895ab1a)
- chore(deps): adopt ts-* 0.4.66 with post-spawn acceptance (9a672b981)
- docs(g61): record verification and release blocker (8acf152b3)
- docs(g61): record forced verification for 0834 (4707cc9b5)
- docs(g61): record forced verification for 0833 (cc05ef893)
- docs(g61): record forced verification for 0832 (daaa73315)
- docs(g61): record forced verification for 0831 (4be5c47ec)
- docs(g6): record fresh prototype browser verification (0830) (750b16dc3)
- docs(g6): refresh strategy simulation verification (0829) (551f28ea8)
- docs(g6): distinguish historical inventory from successor evidence (0828) (5c52e059d)
- docs(report): record I21 closeout verdicts and evidence (a11e70667)
- docs(feature): close I21 with verified task and dogfood evidence (7626076ff)
- docs(task): correct quality gate test count (0823) (bc7fe9142)
- docs(task): record I21 re-verification evidence (0827) (7523c1762)
- docs(task): record I21 re-verification evidence (0826) (8bea813e6)
- docs(task): record I21 re-verification evidence (0825) (3ed02f88c)
- docs(task): record I21 re-verification evidence (0824) (a278e17db)
- docs(task): record I21 re-verification evidence (0823) (d47eda64c)
- docs(task): record I21 re-verification evidence (0822) (d2207ef74)
- docs(task): record I21 re-verification evidence (0821) (a25bf9740)
- docs(task): record I21 re-verification evidence (0820) (1ea1d27b1)
- docs(task): record I21 re-verification evidence (0819) (a17f50973)
- chore(project): add new script entry gate (6096fdafc)
- test: silence test output leaks (act warnings, CORS noise, stdio spills) (e10a4d2c6)
- chore: regenerate idea-handoff bundle for post-merge dependency graph (a9c137159)
- chore: merge 'wayfind/project-agent-fleet' into main (a1c255b13)
...
- bound whole-corpus rollup derivations (0763) (76445f3fb)
- add migration 0039 bounded rollup derivations (0763 R4/R8) (6f56b79af)
- bind verified-outcome records to the certifying run's definition digest (0759 R5) (e3af152e6)
- close out D9 batch verify — proportional routing recorded at the Option B stop (15997f08c)
- migrate task-pipeline to proportional gates (0759) (a5b66e8dc)
- pilot proportional routing on wrapup-pipeline and task-lifecycle (0758) (c84fcd61a)
- wire tool alias resolution seam into rollups and forensic queries (0739) (9e4d4817f)
- proportional route table scaffold for pilot (e72f3e973)
- inline pipeline driver ownership + executable parity check (0755) (cce341765)
- optional behavior-neutral version contract in both dialects (0756) (ab6ccc093)
- unify resolve/preflight seam and bind resume to definition (0752) (6e2a8b5f4)
- import ledger compaction without affecting board reads (0746) (7dd7b2023)
- verify History surface unchanged and record latency (0745) (62663b2be)
- fail-closed proof chain - task lookup and proofBinding write guard (0751) (c838f89f4)
- sort and paginate session listing in SQL on both read paths (0744) (654c23648)
- dimension marts and Summary read routing with stale fallback (0743) (0b2a85f89)
- incremental rollup refresh engine with per-table freshness (0741) (286db3816)
- complete measure vector and enforce additivity invariant (0740) (9b89ea180)
- 0739 persist tool identity, effective_tool_name, tool_name_alias, and alias resolution seam (7890d0d24)
- 0738 history schema trust gate, dependency drift check, and version abort (bedd18d2d)
- repatriate DDL ownership, schema version, and table registry (E92) (86199d95c)
- retire history.refresh.schedule_minutes in favor of bootstrap.scheduler.jobs (0750) (69e189adc)
- spec E91 incremental rollup materialization and E92 DDL ownership repatriation (061f6567e)

### Fixed

- accept exact task-local Gherkin scenario titles in answer lint (664bc93f4)
- repair 0763 re-verification gaps and advance rollup definition to v4 (91cab8c66)
- silence eval-pipeline worktree-cleanup warning for already-gone worktrees (d64f8a861)
- revert 0758 task-lifecycle pilot — sibling edges denied every forward hop (0f99559f2)
- restore package schema refs and append route-reason action in precheck (9a0e50b74)
- stop proto shim markers propagating into spawned children (d15a65dc3)
- repair NULL-ts buckets and scope keyed aggregates to the delta (0741) (c859e50dc)
- replace literal config/workflows paths to pass sp-runtime-path (c1470199d)
- suppress literal template warning in proof test and drop unused variables (f5886cf94)
- add TSDoc comments and test coverage for dimension marts (7c1ac24a5)
- sync recorded importer schema version when package upgrades (5a9611d79)
- resolve docs/00_ADR.md merge conflict + correct .spur/config.yaml $schema ref (2e857111f)
- register inline-pipeline-parity-check, correct schema ref (14994580d)
- repair 3 surface-drift mismatches in plugin scripts (b44ecc94a)
- architecture, design, ADR amendments, composition regen (6f6e75cd1)
- architecture section 24 and design capability-attestation label (332d7ec11)
- docs-pipeline budget correction and composition entrypoint check (ddab89f27)
- provision history_tool_call columns before migration 0034 body (20291adb0)
- make docs-pipeline proof fail-closed (task-path lookup) (0760) (bcdec29cd)
- repair action options, run-id confinement, nested composition, dry-probe escalation noise (0753) (7ab015b73)
- silence intentional failure logging in importer-schema-check unit tests (7e65262e8)

### Changed

- lock tool-identity provisioning against a pre-0.4.56 database (0739) (08ef48976)
- pin the rollup derivation digest per definition version (0741 R6) (a5f0e3959)
- make the mart day predicate sargable (0741) (f5d8c010a)
- align validate test with unversioned tag contract and format baseline (9ac80122b)
- assert incremental rollups equal a full rebuild (0742) (3bca435f9)
- use template literals over string concatenation in schema version tests (04c51ce0f)

### Other

- record final verdicts, re-verification review, and E91 benchmark (532ee37e3)
- record D9 Option B closure and re-verify affected tasks (f80f668e3)
- correct protected-files .spur/ exclude rationale (cb9c495c5)
- update the default scheduler jobs for LLM history (ca162c417)
- 0763 wrap-up — design sync, learnings, metrics (d87083f9c)
- close out D9 — re-verify 0759/0754 and close 0758/0759 at the Option B stop (fd20405ab)
- update task status after refinment (8bdaceeb2)
- update task status after refinment (662e959b2)
- update task status after refinment (9912a5498)
- refine 0763 background and requirements (7bbf6ab43)
- update composition baseline for proportional routing actions (be411b1cd)
- advance D9 active -> verifying (9226e7027)
- refresh D9 task table and format wrapup comments (0737fd21f)
- advance 0760 to done (38ff6cb47)
- advance 0758 and 0759 to wip (merge feat/d9-batch-runall-part2) (21f0fc063)
- advance 0758 and 0759 to wip (c293efc3a)
- open 0763 to bound the whole-corpus rollup derivations (d15512408)
- record the measured E91 verification and amend 0741 R8 (e26e32795)
- adjust sandbox permission (4273b8786)
- adjust sheduler jobs (01db66f2f)
- task-pipeline proportional migration plan (fa6ba8d38)
- remove accidental .tmp file (fe38e015a)
- R1-R7 done, R5 staged, R8 needs decision (6235d74f6)
- add file:line change map for L3 Solution guard (1837efd87)
- re-measure workflow run-economy — Option A continues (6b97598a2)
- add file:line change map to satisfy L3 Solution guard (2b5c13a09)
- Merge E91 (History read path materialized-only) into main (b61cf1e24)
- make eval-pipeline worktree cleanup idempotent and temp-dir-safe (a67f5ee1f)
- mark E91 feature done (aed6df845)
- consolidate 0751 review follow-ups into 0760, cancel 0761/0762 (f26f912b2)
- record 0741 review findings and R7 interruption-recovery fix (73ba189b9)
- record D8 strategy approval and conditional re-measure gate (d7614f6ad)
- create D9 workflow-seam-stabilization-and-proportional-gate-rollout (8249953db)
- refresh AC evidence schema across 0747-0749 task files (0f896a8e4)
- eliminate root dependency version duplication via catalog (d32607d23)
- bump @gobing-ai/ts-* packages to 0.4.55 (5d8be29fd)
- complete task 0750 retire history.refresh.schedule_minutes (e53773f74)
- update spur config file (c1d6355ff)
- refresh corpus baseline and local settings (69a147582)
- decompose E91+E92 into tasks 0738-0749 and adjust related tasks (2b5173450)
- history incremental materialization companion design (D1-D11) (51cc9421a)
- add ADR-104/105/106 for history materialization (aabfdf481)
